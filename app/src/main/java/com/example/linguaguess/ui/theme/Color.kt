package com.example.linguaguess.ui.theme
...
val RgLightYellow = Color(0xFFE2C742)
val RgDarkYellow = Color(0xFFB89000)

val RgLightRed = Color(0xFFFA2525)
val RgDarkRed = Color(0xFFB10C0C)

val RgLightGreen = Color(0xFFA4DB60)
...
val MedBackgroundYellow = Color(0xFFFFF3B3)
val HardRed = Color(0xFFE70202)
val HardBackgroundRed = Color(0xFFFCB3B3)
